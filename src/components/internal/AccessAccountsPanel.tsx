...
import { Plus, X, KeyRound, Trash2, ShieldCheck, Power } from 'lucide-react';
              ...
              {isLoading ? (
                ...
                accounts.map(account => (
                  <tr key={account.id} className="hover:bg-slate-50/80 transition-colors">
                    <td className="py-4 px-4 sm:px-6 font-bold text-slate-900">{account.display_name}</td>
                    <td className="py-4 px-4 sm:px-6 text-slate-500 font-mono">{account.username}</td>
