...
export type InternalTab = 'waiter' | 'kitchen' | 'cashier' | 'owner';
  ...
  return (
    <div className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-2.5 shadow-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        {/* Pestañas de Módulos Operativos */}
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-amber-50 border border-amber-300 text-amber-900 hover:bg-amber-100 text-xs font-bold transition-colors shadow-sm"
          >
            <Coins className="w-3.5 h-3.5 text-amber-600" />
            <span>Arqueo de Caja (X/Z)</span>
          </button>
